...
///
/// Tenir un registre des traitements phytosanitaires est une obligation. Kliima
...
struct TreatmentRecord: Equatable {
    ...
    let at: Date
    let parcelle: String
    /// Renseigné par l'exploitant : Kliima ne l'invente pas.
    let product: String?
    ...
    /// Ce que Kliima aurait conseillé — indicatif, sans valeur réglementaire.

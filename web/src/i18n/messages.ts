...
export const webMessages: Record<Language, Catalog> = {
  fr: {
    ...
    'pro.lead': 'Sur iPhone et Apple Watch, Kliima Pro ajoute :',
  ...
  en: {
    ...
    'pro.lead': 'On iPhone and Apple Watch, Kliima Pro adds:',
  ...
  es: {
    ...
    'pro.lead': 'En iPhone y Apple Watch, Kliima Pro añade:',
